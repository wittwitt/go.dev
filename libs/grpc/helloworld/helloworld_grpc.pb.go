...
const (
	...
	Greeter_SayHello2_FullMethodName = "/Greeter/SayHello2"
)
...
type GreeterClient interface {
	...
	SayHello2(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRes, error)
}
...
func (c *greeterClient) SayHello2(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRes, error) {
	out := new(HelloRes)
	err := c.cc.Invoke(ctx, Greeter_SayHello2_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	SayHello2(context.Context, *HelloReq) (*HelloRes, error)
...
func (UnimplementedGreeterServer) SayHello2(context.Context, *HelloReq) (*HelloRes, error) {
...
func _Greeter_SayHello2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHello2(ctx, req.(*HelloReq))
	}
	return interceptor(ctx, in, info, handler)
}
